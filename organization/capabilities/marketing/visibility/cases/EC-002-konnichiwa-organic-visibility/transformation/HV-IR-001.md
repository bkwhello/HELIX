...
| Confidence | Hoog voor "de tag vuurt nu af". **`reservation_click`: bijgewerkt 26 augustus 2026 (observations/O-018.md) — Production Verified**, via een gerichte testklik en GTM/GA4-reconciliatie (zie O-018 voor het volledige bewijs). De overige losse events (`phone_click`, `reservation_widget_open`, enz. uit HV-MP-001 §7) blijven ongewijzigd: nog niet gemeten of ze daadwerkelijk correct doorkomen — vereisen elk nog een eigen gerichte testklik. |
